...
while True:
    try:
        ...
        lux = ltr559.get_lux()     
        amps = noise.get_amplitude_at_frequency_range(100, 8000)
        ...
        data = '[{{ "temperature": "{0:05.2f}", "humidity": "{1:05.2f}", "light": "{2:05.2f}","noise": "{3:05.2f}", "time": "{4}" }}]'.format(temperature,humidity,lux,amps,now)
